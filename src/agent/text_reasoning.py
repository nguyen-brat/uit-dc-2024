...
def main():
    ...
    parser.add_argument("--model", type=str, default="Qwen/Qwen2-7B-Instruct") # arcee-ai/Arcee-VyLinh
    parser.add_argument("--input_path", type=str, default="data/public_train/vimmsd-train.json")
    parser.add_argument("--output_path", type=str, default="data/public_train/text_reasoning.json")
