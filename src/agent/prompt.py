...
TRAIN_USER_INS_V2 = """Hãy tưởng tượng bạn là người kiểm duyệt nội dung trên facebook, bạn cần lý luận \
...
TRAIN_SYS_RESPONSE_V2 = '''Nhận định về tính châm biếm trong chú thích của bài đăng: {text_reasoning}
